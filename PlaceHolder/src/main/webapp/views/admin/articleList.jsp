...
<body>
	...
	<div class="container">
				...
				<div class="container" style="text-align: center;">
					...
					<c:forEach var="list" items="${articleList}">
						<div class="row"
							...
							<div class="col-2 userId">${list.postId}</div>
							<div class="col-3">${list.userId}</div>
							<div class="col-4">
								<a href="detail.article?postId=${list.postId}"
									style="text-decoration-line: none;">${list.postTitle}</a>
							</div>
							<div class="col-3">${list.postCreated}
								<a href="/articleDelete.admin?postId=${list.postId}"
     ...
     //검색어 입력했을 때
        ...
        location.href = "/searcharticle.admin?option=" + searchOption + "&Keyword=" + searchTxt; // get으로 검색값 전달
        })
