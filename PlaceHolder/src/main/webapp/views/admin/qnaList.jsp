				...
				<div class="container" style="text-align: center;">
					...
					<c:forEach var="list" items="${qnaList}">
						<div class="row"
							...
							<div class="col-2 userId">${list.inquiry}</div>
							<div class="col-2" style="overflow: hidden;">${list.hotelId}</div>
							<div class="col-2">${list.userId}</div>
							<div class="col-2">${list.inquiryStat}</div>
							<div class="col-4" style="text-align: right;">${list.inquiryContent}
								<a href="/qnaDelete.admin?userId=${list.userId}"
