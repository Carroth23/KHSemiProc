	...
	<div class="container">
				...
				<div class="container" style="text-align: center;">
					...
					<c:forEach var="list" items="${userList}">
						<div class="row"
							...
							<div class="col-2 userId">${list.userId}</div>
							<div class="col-2" style="overflow: hidden;">${list.userName}</div>
							<div class="col-2">${list.userNickname}</div>
							<div class="col-3">${list.userEmail}</div>
							<div class="col-3">${list.userPhone}
								<a href="/userDelete.admin?userId=${list.userId}"
     ...
     let searchBtn = document.querySelector(".detailSearchBtn");
        searchBtn.addEventListener("click", function () { // 검색버튼을 누를때 option의 값을 빼냄
          ...
          location.href = "/userSearch.admin?Keyword=" + searchTxt; // get으로 검색값 전달
        })
