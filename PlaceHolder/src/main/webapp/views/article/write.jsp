	...
	<div class="container">
		<div class="containerIn">
          ...
          <!-- 사이드바 코드 끝 -->
				...
				<!-- 내용물 -->
				<form action="/write.article" method="get" id="writeForm">
					<div class="container">
						<div class="row title">
							<div class="col title" style="text-align: center;">
								<br> <br> <label>제목 : </label> <input type="text"
									id="postTitle" name="postTitle" style="width: 70%;"
						...
						<div class="row content">
							<div class="col content" style="text-align: center;">
								<textarea rows="20" cols="90" id="postContent"
						...
						<div class="row button">
							<div class="col button" style="text-align: right;">
								<a href="javascript:history.back()"> <input type="button"
									value="목록으로">
								</a> <input type=reset values="초기화" style="width: 60px;"> <input
									type=submit values="글 작성" style="width: 60px;">
							</div>
						</div>
					</div>
				</form>
